...
export default function VideoPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if ((is26 || !isMotion) && !prompt && !imageUrl) throw new Error('Provide prompt or image input.')
      ...
      const data = await generateVideo({
        ...
        negative_prompt: !isMotion ? (negativePrompt || undefined) : undefined,
        cfg_scale: cfgScale,
        aspect_ratio: is26 ? aspectRatio : undefined,
        generate_audio: is26 ? generateAudio : undefined,
